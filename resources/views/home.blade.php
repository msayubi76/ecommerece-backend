...
@section('content')
    ...
    <section style="margin-top:0px;">
        <div class="container-fluid">
            <div class="row hero-content-main">
                <div class="col-lg-12 col-md-12 col-sm-12 responsive-ps ps-5 " style="margin-top:65px;margin-bottom:65px;">
                    <h3 class="animate__animated animate__backInRight hero-title-top" style="color: #edbf67;">
                        {{ isset($landing_page_text) ? $landing_page_text['header_title_3'] : '' }}
                    </h3>
                    <h1 class="animate__animated animate__backInLeft hero-title-main" style="color: #ffffff;">
                        {{ isset($landing_page_text) ? $landing_page_text['header_title_1'] : '' }}
                    </h1>
                    <h4 class="animate__animated animate__bounceIn animate__delay-1s hero-title-three" style="color: #ffffff;">
    ...
    <section class="about-section">
        <div class="container-fluid">
            <div class="row about-section-row" style="background: #FFC94F;">
               <!-- <div class="col-lg-6 col-md-6 col-sm-12 about-us-left justify-content-center">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 about-us-right-column" style="margin-bottom: 100px;margin-top: 90px;">
                    <div class="about-us__right animate__animated animate__backInRight" style="color:black;">
                        <h3 style="color:#000;">{{ translate('messages.about_us') }}</h3>
                        <h2 style="color:#000;">{{ isset($landing_page_text) ? $landing_page_text['about_title'] : '' }}</h2>
                        <p class="about-us-text" style="color:#000000;">
                            {!! \Illuminate\Support\Str::limit(\App\CentralLogics\Helpers::get_settings('about_us'), 200) !!}
                        </p>
                        <a href="{{ route('about-us') }}"
                            class="btn btn-lg read-more mt-4" style="background-color: #0e3753;color:#ffffff;">{{ translate('messages.read_more') }}</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 our-app-text-box">
                        <div class="about-us-right align-center">
                            <h3 style="color:#000;">{{ translate('messages.our_mobile_applications') }}</h3>
            ...
            <div class="container why-choose-us">
                <div class="row text-center d-flex justify-content-center responsive-css">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="main-heading-underline mx-auto" style="background:#ffc94f"></div>
                    </div>
    ...
    @endif
    <section class="subscription" style="background: #ffc94fd4;">
        <div class="container">
            <div class="subscription" style="background:#FFC94F;">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="news-heading-underline mx-auto" style="background:#0f3753;"></div>
                    </div>
                    <div class="col-md-6">
                        <div class="search">
                            <form id="newsLetterForm" method="post" action="{{ route('newsletter.subscribe') }}">
                                ...
                                <button type="submit" class="btn btn-info subscribe-btn" style="background: #0f3753;"><i
                            ...
                            <div class="col owl-item">
                                <div class="testimonial">
                                    ...
                                    <div class="testimonial-content">
                                        <h3 class="testimonial-title" style="color:#ffc94f;">
                                            {{ $data['name'] }}
