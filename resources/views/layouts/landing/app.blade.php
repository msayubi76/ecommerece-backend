...
<body>
    ...
    @yield('content')
    <!-- FOOTER -->
    <footer class="w-100 pb-4 rounded-left footer-bg" style="background-color: #ffc94f;">
        <div class="container">
            ...
            @else
                col-md-3 @endif footer-col">
                    ...
                    <h5 class="mb-3">{{ translate('messages.quick_links') }}</h5>
                ...
                @if ($landing_page_links['app_url_android_status'] !== null || $landing_page_links['app_url_ios_status'] !== null)
                    <div class="col-md-3 footer-col">
                        <h5 class=" mb-3">{{ translate('messages.download_our_apps') }}</h5>
                ...
                @else
                    col-md-3 @endif footer-col">
                    <h5 class=" mb-2">{{ translate('messages.contact_us') }}</h5>
