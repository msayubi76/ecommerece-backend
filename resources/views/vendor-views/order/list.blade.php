                    ...
                    @foreach($orders as $key=>$order)
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            <td class="text-capitalize">
                             ...
                             <td class="text-capitalize">
                                @if($order["delivery_type"]=='Car Delivery')
                                    <span class="badge badge-soft-dark ml-2 ml-sm-3">
                                        <span class="legend-indicator bg-dark"></span>Car
                                    </span>
                                @else
                                @if($order["delivery_type"]=='Bike Delivery')
                                    <span class="badge badge-soft-dark ml-2 ml-sm-3">
                                        <span class="legend-indicator bg-dark"></span>Bike
                                    </span>
                                @else
                                    <span class="badge badge-soft-warning ml-2 ml-sm-3">
                                      <span class="legend-indicator bg-warning"></span>Leapord Courier
                                    </span>
                                @endif
                                @endif
                            </td>
