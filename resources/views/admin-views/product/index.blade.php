        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="javascript:" method="post" id="item_form"
                    ...
                    <div class="row" style="border: 1px solid #ebe5e5;border-radius: 10px;">
                        <legend style="text-align: center;color: #ff2929;">Not required for food category</legend>
                         <div class="col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Weight (e.g In grams)</label>
                                <input type="text" name="weight" class="form-control" id="weight"
                                       placeholder="Ex : 1000 gm">
                            </div>
                        </div>
                         <div class="col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Package Details</label>
                               <div class="row">
                                   <div class="col-lg-4">
                                        <input type="text" name="length" class="form-control" id="length"
                                       placeholder="Ex : Length in cm">
                                   </div>
                                   
                                   <div class="col-lg-4">
                                        <input type="text" name="width" class="form-control" id="width"
                                       placeholder="Ex : Width in cm">
                                   </div>
                                   
                                   <div class="col-lg-4">
                                        <input type="text" name="height" class="form-control" id="height"
                                       placeholder="Ex : Height in cm">
                                   </div>
                               </div>  
                            </div>
                        </div>
