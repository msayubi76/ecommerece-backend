                ...
                <form action="{{ route('admin.business-settings.update-setup') }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline text-capitalize"
                                    for="minimum_shipping_charge">{{ translate('messages.minimum_shipping_charge') }} Bike</label>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline text-capitalize"
                                    for="per_km_shipping_charge">{{ translate('messages.per_km_shipping_charge') }} Bike</label>
                        ...
                        <div class="col-md-4 col-12">
                            @php($minimum_shipping_charge_car = \App\Models\BusinessSetting::where('key', 'minimum_shipping_charge_car')->first())
                            <div class="form-group">
                                <label class="input-label d-inline text-capitalize"
                                    for="minimum_shipping_charge_car">{{ translate('messages.minimum_shipping_charge') }} Car</label>
                                <input type="number" name="minimum_shipping_charge_car" class="form-control"
                                    id="minimum_shipping_charge_car" min="0" step=".01"
                                    value="{{ $minimum_shipping_charge_car ? $minimum_shipping_charge_car->value : 0 }}" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            @php($per_km_shipping_charge_car = \App\Models\BusinessSetting::where('key', 'per_km_shipping_charge_car')->first())
                            <div class="form-group">
                                <label class="input-label d-inline text-capitalize"
                                    for="per_km_shipping_charge_car">{{ translate('messages.per_km_shipping_charge') }} Car</label>
                                <input type="number" name="per_km_shipping_charge_car" class="form-control"
                                    id="per_km_shipping_charge_car" min="0" step=".01"
                                    value="{{ $per_km_shipping_charge_car ? $per_km_shipping_charge_car->value : 0 }}" required>
                            </div>
                        </div>
