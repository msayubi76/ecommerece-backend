...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'vendor', 'as' => 'vendor.'], function () {
                ...
                Route::get('get-account-data/{store}', 'VendorController@get_account_data')->name('storefilter_');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings','actch']], function () {
            ...
            Route::POST('app-settings', 'BusinessSettingsController@update_app_settings')->name('app-settings_');
            Route::get('landing-page-settings/{tab?}', 'BusinessSettingsController@landing_page_settings')->name('landing-page-settings');
            Route::POST('landing-page-settings/{tab}', 'BusinessSettingsController@update_landing_page_settings')->name('landing-page-settings_');
        ...
        Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.'], function () {
            ...
            Route::group(['middleware' => ['module:deliveryman']], function () {
                ...
                Route::get('edit/{id}', 'DeliveryManController@edit')->name('edit');
                  Route::get('approve/{id}', 'DeliveryManController@approve')->name('approve');
