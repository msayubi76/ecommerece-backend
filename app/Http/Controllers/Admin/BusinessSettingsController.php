...
class BusinessSettingsController extends Controller
{
    ...
    public function business_setup(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['key' => 'per_km_shipping_charge'], [
         ...
         DB::table('business_settings')->updateOrInsert(['key' => 'minimum_shipping_charge_car'], [
            'value' => $request['minimum_shipping_charge_car']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'per_km_shipping_charge_car'], [
            'value' => $request['per_km_shipping_charge_car']
        ]);
