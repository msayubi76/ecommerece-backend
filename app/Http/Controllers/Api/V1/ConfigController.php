...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'per_km_shipping_charge_car' => (double)$settings['per_km_shipping_charge_car'],
            'minimum_shipping_charge_car' => (double)$settings['minimum_shipping_charge_car'],
